(function() {
    ...
    var utils = UM.utils,
        ...
        Base = {
            ...
            close: function($img) {
                ...
                $img.css({
                    ...
                    $.post("/api/photos/delete", {
                        ...
                        if (data.status) {
                            if ($(self).parent().remove().hasClass("edui-image-upload-item")) {
                                //显示图片计数-1
                                Upload.showCount--;
                                Upload.updateView();
                            }
            ...
            callback: function(editor, $w, url, state, imgId) {
    ...
    var Upload = {
        ...
        uploadComplete: function(r) {
            ...
            try {
                var json = eval('(' + r + ')');
                Base.callback(me.editor, me.dialog, json.result.src, json.status, json.result.id);
            } catch (e) {
        ...
        submit: function(callback) {
            ...
            $(me.dialog).delegate(".edui-image-file", "change", function(e) {
                ...
                $('<iframe name="up"  style="display: none"></iframe>').insertBefore(me.dialog).on('load', function() {
                    var r = this.contentWindow.document.body.firstChild.innerHTML;
                    if (r == '') return;
                    me.uploadComplete(r);
                    $(this).unbind('load');
                    $(this).remove();
