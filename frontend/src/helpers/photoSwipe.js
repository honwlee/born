define([
    ...
    "photoswipe",
    "photoswipeUi",
    "text!data/photos.json",
    "handlebars"
], function(skylarkjs, $, partial, _PhotoSwipe, PhotoSwipeUI_Default, photosData, handlebars) {
    var langx = skylarkjs.langx;
    var PhotoSwipe = langx.Evented.inherit({
        ...
        init: function(config) {
            ...
            var tpl = handlebars.compile("{{> photoSwipe-partial}}");
            this.tpl = tpl({
                photos: this._formatPhotoData(this.photoData)
            });
        },
        ...
        _initPhotoSwipeFromDOM: function(gallerySelector) {
            ...
            var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
                ...
                gallery = new _PhotoSwipe(pswpElement, PhotoSwipeUI_Default, items, options);
            ...
            var galleryElements = gallerySelector.children();
