define([
    ...
    return spa.RouteController.inherit({
        ...
        entered: function() {
            $(".main-wrapper .navbar:first").addClass("hide");
            $(".main-wrapper .footer:first").addClass("hide");
        },
        exited: function() {
            $(".main-wrapper .navbar:first").removeClass("hide");
            $(".main-wrapper .footer:first").removeClass("hide");
        }
    });
});