define([
...
], function(skylarkjs, hbs, metusaTpl) {
    var spa = skylarkjs.spa,
        langx = skylarkjs.langx,
        $ = skylarkjs.query;
    selector = $(langx.trim(metusaTpl));
    var Data = [{
        imgUrl: "./assets/images/metusa/0.png",
        title: "去美国生宝宝 产后忌口",
    ...
    [1, 2, 3, 4, 5].forEach(function(i) {
        Data.push({
            imgUrl: "./assets/images/metusa/" + i + ".png"
        });
    });
    ...
    return spa.RouteController.inherit({
        ...
        rendering: function(e) {
            var tpl = hbs.compile(langx.trim(selector.find("#metusa-wrap").html()).replace("{{&gt;", "{{>")),
                self = this,
                _ec = $(tpl({
                    data: Data,
